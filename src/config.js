/**
 * @file Defines the module configuration fields (IP, Port, Credentials) shown in the Companion settings tab.
 */
	...
	return [
		{
			...
			width: 12,
			label: 'Information',
			value: 'This module controls Atlona PTZ cameras using the VISCA over IP protocol.',
		},
		{
			type: 'textinput',
			id: 'host',
		...
		},
		{
			type: 'textinput',
			id: 'port',
			label: 'Target Port (default: 1259)',
			width: 4,
			regex: Regex.PORT,
			default: '1259',
		},
		...
		},
		{
			type: 'number',
			id: 'pollingInterval',
			label: 'Standard Polling Interval (ms)',
			width: 4,
			default: 100,
			min: 100,
			max: 5000,
